...
struct RCChannels {
  uint16_t throttle;   // Channel 0: Throttle (1000-2000 μs)
  uint16_t roll;       // Channel 1: Roll (1000-2000 μs)
  uint16_t pitch;      // Channel 2: Pitch (1000-2000 μs)
  uint16_t yaw;        // Channel 3: Yaw (1000-2000 μs)
  uint16_t mode;       // Channel 4: Mode switch (1000-2000 μs)
  uint16_t aux;        // Channel 5: Auxiliary (1000-2000 μs)
